...
class PluginTreePictures(plugin.PluginTree):
    ...
    def __init__(self):
        ...
        item31.SetSelectedCallback(app.SetBackgroundImage,"sample_data/pictures/nature/house.jpg")
        ...
        item32.SetSelectedCallback(app.SetBackgroundImage,"sample_data/pictures/nature/mountain.jpg")
        level3.AddItem(item32) 
        
        item33 = menu.MenuItem("tree")
        item33.SetPicturePathAndFilename("sample_data/pictures/nature/tree.jpg")
        item33.SetSelectedCallback(app.SetBackgroundImage,"sample_data/pictures/nature/tree.jpg")
        level3.AddItem(item33) 
        
        item34 = menu.MenuItem("wall")
        item34.SetPicturePathAndFilename("sample_data/pictures/nature/wall.jpg")
        item34.SetSelectedCallback(app.SetBackgroundImage,"sample_data/pictures/nature/wall.jpg")
        ...
        item41.SetSelectedCallback(app.SetBackgroundImage,"sample_data/pictures/animals/duck.jpg")
        ...
        item42.SetSelectedCallback(app.SetBackgroundImage,"sample_data/pictures/animals/lambs.jpg")
        level4.AddItem(item42) 
        
        item43 = menu.MenuItem("tree")
        item43.SetPicturePathAndFilename("sample_data/pictures/animals/dogs.jpg")
        item43.SetSelectedCallback(app.SetBackgroundImage,"sample_data/pictures/animals/dogs.jpg")
        level4.AddItem(item43) 
        
        item44 = menu.MenuItem("wall")
        item44.SetPicturePathAndFilename("sample_data/pictures/animals/hippo.jpg")
        item44.SetSelectedCallback(app.SetBackgroundImage,"sample_data/pictures/animals/hippo.jpg")
